...
function OrderFilter() {
  ...
  const { register, handleSubmit, control, formState, reset } = useForm({
    defaultValues: {
      customerName: searchParams.get("customer-name") || "",
  ...
  function onSubmit(data) {
    const { customerName, fromDate, toDate } = data;
    ...
    searchParams.set("customer-name", customerName.trim());
  ...
  function resetParams() {
    ...
    searchParams.set("customer-name", "");
  ...
  return (
    <form
      ...
      className="flex flex-col gap-4 md:grid md:grid-cols-2 md:grid-rows-[1fr,1fr,auto]"
    >
